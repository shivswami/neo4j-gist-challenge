...
* Graph images have been created with from GraphML edited via and converted to Cypher CREATE statements as describe https://github.com/jotomo/graph-tools[here]
